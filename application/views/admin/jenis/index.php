                ...
                <table class="table">
                    ...
                    <?php foreach ($jenis as $list): ?>
                        <tr>
                            ...
                            <td>
                                <button class="btn btn-warning btn-xs" onclick="detailData('<?= $list["idclass"] ?>')">
                                    Detail
                                </button>
                                <button class="btn btn-success btn-xs" onclick="updateData('<?= $list["idclass"] ?>')">
                                    Update
                                </button>
                                <button class="btn btn-danger btn-xs btn-delete"
                                        onclick="confirmDeleteModal('<?= $list["idclass"] ?>')">
                                    Hapus
                                </button>
                            </td>
                        </tr>
    ...
    <div class="col-md-5 col-lg-5">
        <div class="panel panel-warning">
            ...
            <div class="panel-body">
                ...
                <form action="<?= site_url('admin/jenis/create') ?>" method="post" class="form-horizontal"
                    ...
                    <fieldset>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-3">
                                <input id="kode" maxlength="6" name="kode" type="text" placeholder=""
                                       value="<?= set_value('kode') ?>" class="form-control input-md" required="">
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                <input id="jenis" maxlength="40" name="jenis" type="text" placeholder=""
                                       value="<?= set_value('jenis') ?>" class="form-control input-md" required="">
                            </div>
                        </div>
                        <!-- Text input-->
                        <div class="form-group">
                            ...
                            <div class="col-md-3">
                                <input id="harga" maxlength="20" name="harga" type="text" placeholder=""
                                       value="<?= set_value('harga') ?>" class="form-control input-md" required="">
                            </div>
...
<script type="text/javascript">
    ...
    function detailData(id) {
        $.ajax({
            type: "POST",
            url: "<?=site_url('admin/jenis/details')?>",
            data: "id=" + id,
    ...
    function updateData(id) {
        $.ajax({
            type: "POST",
            url: "<?=site_url('admin/jenis/viewUpdate')?>",
            data: "id=" + id,
            success: function (msg) {
                $("#div_result").html(msg);
            }
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <p>Jenis ini tidak akan ditemukan pada transaksi yang mungkin akan terjadi di masa yang akan datang.
