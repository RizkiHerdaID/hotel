                ...
                <table class="table">
                    ...
                    <?php foreach ($tamu as $list): ?>
                        <tr>
                            ...
                            <td><?= $list['nama'] ?></td>
                            <td>
                                <button class="btn btn-warning btn-xs" onclick="detailData('<?= $list["id"] ?>')">
                                    Detail
                                </button>
                                <button class="btn btn-success btn-xs" onclick="updateData('<?= $list["id"] ?>')">
                                    Update
                                </button>
                                <button class="btn btn-danger btn-xs btn-delete"
                                        onclick="confirmDeleteModal('<?= $list["id"] ?>')">
                                    Hapus
                                </button>
                            </td>
                        </tr>
    ...
    <div class="col-md-5 col-lg-5">
        <div class="panel panel-warning">
            ...
            <div class="panel-body">
                ...
                <form action="<?= site_url('admin/tamu/create') ?>" method="post" class="form-horizontal"
                      enctype="multipart/form-data" role="form">
                    <fieldset>
                        <div class="form-group">
                            <label class="col-md-4 control-label" for="ktp">KTP / KTM / Passport</label>
                            <div class="col-md-8">
                                <input id="ktp" name="ktp" type="text" value="<?= set_value('ktp') ?>" placeholder=""
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                <input id="fname" name="fname" type="text" value="<?= set_value('fname') ?>"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                <input id="lname" name="lname" type="text" value="<?= set_value('lname') ?>"
                                       placeholder="" class="form-control input-md" required="">
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                <input id="phone" name="phone" type="text" value="<?= set_value('phone') ?>"
                                       placeholder="" class="form-control input-md" required="">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                <select id="country" name="country" class="form-control">
                                    <?php foreach ($negara as $country): ?>
                                        <option value="<?= $country['country_id'] ?>" <?php if ($country['country_id'] == 101 OR set_value('country')) {
                                            echo 'selected';
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                <input id="address" name="address" type="text" value="<?= set_value('address') ?>"
                                       placeholder="" class="form-control input-md" required="">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                <input id="province" name="province" type="text" value="<?= set_value('province') ?>"
                                       placeholder="" class="form-control input-md" required="">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                <input id="city" name="city" type="text" value="<?= set_value('city') ?>" placeholder=""
                                       class="form-control input-md" required="">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                <input id="zipcode" name="zipcode" type="text" value="<?= set_value('zipcode') ?>"
                                       placeholder="" class="form-control input-md" required="">
                            </div>
                        </div>
                        <div class="form-group">
...
<script type="text/javascript">
    ...
    function detailData(id) {
        $.ajax({
            type: "POST",
            url: "<?=site_url('admin/tamu/details')?>",
            data: "id=" + id,
    ...
    function updateData(id) {
        $.ajax({
            type: "POST",
            url: "<?=site_url('admin/tamu/viewUpdate')?>",
            data: "id=" + id,
            success: function (msg) {
                $("#div_result").html(msg);
            }
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <p>Tamu ini tidak akan ditemukan pada transaksi yang mungkin akan terjadi di masa yang akan datang.
                    Namun, histori tamu ini akan tetap ada di setiap transaksi yang pernah tercatat</p>
