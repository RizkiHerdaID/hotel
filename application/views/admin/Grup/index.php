<div class="row">
				...
				<table class="table">
					...
					<tbody>
						...
						<tr>
							...
							<td>
								<button class="btn btn-warning btn-xs" onclick="detailGrup('<?=$list["id_guest_group"]?>')">Detail</button>
							<button class="btn btn-success btn-xs" onclick="updateGrup('<?=$list["id_guest_group"]?>')">Update</button>
					...
					<form action="<?=site_url('admin/grup/create')?>" method="post" class="form-horizontal" enctype="multipart/form-data" role="form">
						<fieldset>
							...
							<div class="form-group">
								...
								<div class="col-md-3">
									<input id="gcode" maxlength="5" name="gcode" type="text" value="<?= set_value('gname')?>" placeholder="" class="form-control input-md" required="">
								</div>
							...
							<div class="form-group">
								...
								<div class="col-md-8">
									<input id="gname" maxlength="50" name="gname" type="text" value="<?= set_value('gcode')?>" placeholder="" class="form-control input-md" required="">
								</div>
							</div>
							<!-- Text input-->
							<div class="form-group">
								...
								<div class="col-md-3">
									<div class="input-group">
										<input id="diskon" maxlength="2" name="diskon" type="text" value="<?= set_value('diskon')?>" placeholder="" class="form-control input-md" required="">
	...
	<script type="text/javascript">
		...
		function detailGrup(id){
			window.location.assign("<?=site_url('admin/grup/details/')?>"+id)
		}

		function updateGrup(id){
			window.location.assign("<?=site_url('admin/grup/viewUpdate/')?>"+id)
		}
	</script>
