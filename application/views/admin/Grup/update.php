...
<div class="col-lg-6">
	<form action="<?=site_url('admin/grup/update')?>" method="post" class="form-horizontal" enctype="multipart/form-data" role="form">
			...
			<div class="panel-body">
				...
				<fieldset>
					...
					<div class="row form-group">
						...
						<div class="col-md-8">
							<input id="gname" maxlength="50" name="gname" type="text" value="<?= $list['nama']?>" placeholder="" class="form-control input-md" required="">
						</div>
					</div>
					<!-- Text input-->
					<div class="row form-group">
						...
						<div class="col-md-3">
							<div class="input-group">
								<input id="diskon" maxlength="2" name="diskon" type="text" value="<?= $list['diskon']?>" placeholder="" class="form-control input-md" required="">
