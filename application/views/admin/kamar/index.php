<div class="row">
					...
					<tbody>
						...
						<tr
							...
							<td>
								...
								<button class="btn btn-warning btn-xs <?php if ($list['status'] == 0) {echo 'disabled';} ?> " onclick="detailData('<?=$list["idrooms"]?>')">Detail</button>
								<button type="button"
								<?php
								if ($list['status'] == 1) {
	...
	<script type="text/javascript">
		...
		function detailData(id){
			window.location.assign("<?=site_url('admin/kamar/details/')?>"+id)
		}
	</script>
