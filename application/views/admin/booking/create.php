	...
	<div class="col-lg-12">
		<div class="panel panel-warning">
			...
			<div class="panel-body">
				<div class="row">
					<form action="<?=site_url('admin/booking/create')?>" method="post" class="form-horizontal" enctype="multipart/form-data" role="form">
						<div class=" col-md-6 col-lg-6">
							...
							<fieldset>
								...
								<div class="form-group">
									...
									<div class="col-md-8 input-group" style="padding: 0px 15px">
										...
										<span class="input-group-btn">
                                        	<a href="<?=site_url('admin/booking/cariTamu')?>" class="btn btn-info">Cari Tamu</a>
                                    	</span>
									</div>
								</div>
								<div class="form-group">
								...
								<div class="form-group">
									...
									<div class="col-md-8">
										<input id="lname" name="lname" type="text" value="<?=$list['nama_belakang']?>" placeholder="" class="form-control input-md" disabled />
