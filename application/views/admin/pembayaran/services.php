    ...
    <div class="panel panel-warning">
        ...
        <div class="row">
            <div class="panel-body">
                <div class="col-lg-5">
                    <!-- Text input-->
                    <form action="<?= site_url('admin/pembayaran/simpan_jasa    ') ?>" method="post"
                        ...
                        <div class="form-group row">
                            <label class="col-md-4 control-label" for="service">Nama Jasa</label>
                            <div class="col-md-8">
                                <select id="service" name="service" class="form-control">
                                    ...
                                    <?php foreach ($services as $service) {
                                        if ($service['jenis'] == '1') { ?>
                                            <option
                                                value="<?= $service['id_service'] ?>"><?= $service['nama'] ?></option>
                                        <?php }
                                    } ?>
                                </select>
                            </div>
                ...
                <div class="col-lg-7"><h4>Daftar Pesanan Sebelumnya</h4>
                    ...
                    <?php if (count($daftar) > 0) { ?>
                        ...
                        <div style="margin-right:30px" class="pull-right">
                            <label><h4>Total Keselurahan
                                    : <?php echo 'Rp. ' . number_format($total_bayar, '0', '', '.') . ',-'; ?></h4>
                            </label>
                        </div>
                    <?php } else {
                        echo 'Data Kosong';
