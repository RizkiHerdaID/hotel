                        ...
                        ?>>
                            ...
                            <td>
                                <button class="btn btn-success btn-xs"
                                        onclick="updateData('<?= $list["id_service"] ?>')">Update
                                </button>
                                <button class="btn btn-danger btn-xs btn-delete"
                                        onclick="confirmDeleteModal('<?= $list["id_service"] ?>')">
                                    Hapus
                                </button>
                            </td>
                        </tr>
    ...
    <div class="col-xs-5 col-sm-5 col-md-5 col-lg-5">
        <div class="panel panel-warning">
            ...
            <div class="panel-body">
                ...
                <form action="<?= site_url('admin/jasa/create') ?>" method="post" class="form-horizontal"
                      enctype="multipart/form-data" role="form">
                    <fieldset>
                        <div class="form-group">
                            <label class="col-md-4 control-label" for="servicename">Nama</label>
                            <div class="col-md-8">
                                <input id="servicename" vaue="<?= set_value('servicename') ?>" name="servicename"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-3">
                                <input id="price" vaue="<?= set_value('price') ?>" name="price" type="text"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                <label style="margin-right:5pt"><input type="radio" name="jenis" value="0"
                                                                       checked="true"> Jasa Kamar</label>
...
<script type="text/javascript">
    ...
    function updateData(id) {
        $.ajax({
            type: "POST",
            url: "<?=site_url('admin/jasa/viewUpdate')?>",
            data: "id=" + id,
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <p>Jasa ini tidak akan ditemukan pada transaksi yang mungkin akan terjadi di masa yang akan datang.
                    Namun, histori jasa ini akan tetap ada di setiap transaksi yang pernah tercatat</p>
            </div>
